...
of these rules cause no seats to change state! Once people stop moving around,
...
seats for an occupied seat to become empty (rather than four or more from the previous rules).
